...
import me.andpay.ti.daf.dao.simplequery.ArgCollection;
...
public class HQLCondition {
	...
	public static HQLCondition getInstance(String left, String operator, Object right) {
		if ( right != null && right instanceof Object[] ) {
			return getInstance(left, operator, (Object[] )right);
		}
	...
	public static HQLCondition getInstance(String left, String operator, Object[] right) {
		...
		return getInstance(left, operator, list);
	}

	public void setCondition(String left, String operator, Collection<?> right) {
		this.left = left;
		this.operator = operator;
